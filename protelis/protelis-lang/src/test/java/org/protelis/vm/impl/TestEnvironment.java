...
public class TestEnvironment {
    ...
    private final SpatiallyEmbeddedContext[] activeExecutionContexts;
    ...
    protected TestEnvironment(final int deviceNumber, final AbstractLinkingStrategy rule) {
        ...
        activeExecutionContexts = new TestContext[deviceNumber];
    ...
    private void setup() {
        for (int i = 0; i < deviceNumber; i++) {
            ...
            executionContexts[i] = new TestContext(id, this, new TestNetworkManager(id, this),
                    rule.findPosition(id, deviceNumber));
        }
    }
    ...
    /**
     * @return all the execution which sent at least one piece of information.
     */
    public SpatiallyEmbeddedContext[] getActiveExecutionContexts() {
        return activeExecutionContexts;
    }
    ...
    public void putContent(final DeviceUID id, final Map<CodePath, Object> toSend) {
        ...
        activeExecutionContexts[n] = executionContexts[n];
    }
