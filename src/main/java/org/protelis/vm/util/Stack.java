...
public interface Stack extends Serializable {
	 ...
	 * @param canShadow
	 * 		If true, then only values in the same lexical scope are overwritten; others are shadowed.
	 * 		If false, then prior value is always overwritten.
	 * @return
	 * 		Value overwritten, or null if no value is overwritten
	 */
	 ...
	 * @return
	 * 		Value of the variable in the innermost lexical scope where it exists, if bound; otherwise null.
	 */
