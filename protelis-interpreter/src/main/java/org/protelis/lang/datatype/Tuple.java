...
public interface Tuple extends Iterable<Object>, Serializable, Comparable<Tuple> {
    ...
    /**
     * Add an element to the end of a tuple. Equivalent to {@code insert(size, element)}.
     *
     ...
     *
     * @param context the Protelis {@link ExecutionContext}
     * @param mapper the mapping function
     * @return a new tuple whose elements are the elements generated by the application of the provided function
     *     to each element of the tuple, in order.
     */
    default Tuple flatMap(final ExecutionContext context, final FunctionDefinition mapper) {
        return flatMap(JavaInteroperabilityUtils.toFunction(context, mapper));
    }
     ...
     *     to each element of the tuple, in order.
     */
    Tuple flatMap(Function<Object, Tuple> mapper);

    /**
     * Performs a reduction operation that maps a tuple to a single value.
     *
     * @param initial the base value of the computation
     ...
     */
    Object fold(Object initial, BinaryOperator<Object> fun);
     ...
     * @param ctx    the current execution context
     * @param initial the base value of the computation
     * @param fun    the {@link FunctionDefinition} that will be applied to each couple
     *               of values
     * @return a single value of this tuple, or the default value if empty
     */
    default Object fold(final ExecutionContext ctx, final Object initial, final FunctionDefinition fun) {
        return fold(initial, JavaInteroperabilityUtils.toBinaryOperator(ctx, fun));
    }
    ...
    /**
     * Set arithmetic: compute intersection of the set of tuple elements with the set of elements of another tuple.
     *
     ...
     * @return the biggest element of this tuple, if defined, or default otherwise
     */
     ...
     * @return the smallest element of this tuple, if defined, or default otherwise
     */
    Object min(Object def);

    /**
     * Add an element to the start of a tuple. Equivalent to {@code insert(0, element)}.
     *
     * @param element Element to be added
     ...
     * @return a single value of this tuple, or the default value if empty
     */
    default Object reduce(final ExecutionContext ctx, final Object defVal, final FunctionDefinition fun) {
    ...
    /**
     * Set arithmetic: compute union of the set of tuple elements with the set of
